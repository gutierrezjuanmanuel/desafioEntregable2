...
manager.addProduct(bajo);

const bateria = {
    title: "bateria",
    description: "bateria completa",
    price: 15000,
    thumbnail: "sin imagen",
    code: "abc125",
    stock: 30
...
const saxofon = {
    id: 1,
    title: "saxofon",
    description: "el mejor saoxofon del mercado",
    price: 150,
    thumbnail: "Sin imagen",
    code: "abc123",
    stock: 30
...
async function testeamosActualizar() {
    await manager.updateProduct(1, saxofon);
}
